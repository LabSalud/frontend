...
#### NAVBAR
⭕️ agrreglar hambutton de navbar en telefono

#### INGRESO
⭕️ arreglar tabla de analisis para que no aparezca el scroll horizontal en desktop y mobile

#### INICIO
⭕️ arreglar el porcentaje de mas en crecimiento

#### CONFIGURACIONES
⭕️ pedir filtro de analisis y determinaciones de parametro is_active=true
⭕️ en el dialog para crear determinaciones y en el de editar determinaciones, eliminar el input de codigo porque este lo genera automaticamente el backend

#### PROTOCOLOS
⭕️ arreglar dialog de analisis para que no haya barra horizontal

#### PACIENTES
⭕️ arreglar la busqueda de pacientes por endpoint

#### GESTION DE USUARIOS
⭕️ arreglar que no aparecen los roles de los usuarios en la lista

#### RESULTADOS
⭕️ agregar estado de envio fallido en los toogles de filtro
